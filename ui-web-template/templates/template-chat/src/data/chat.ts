...
export const SUGGESTED_PROMPTS: readonly string[] = [
  "把本周产品与设计更新整理成可发给团队的状态摘要。",
  "将产品需求草稿转换为包含负责人和截止日期的上线清单。",
  "面向关注 ROI 的管理者改写这段内容。",
  "为数据分析产品的新手引导流程构思名称。",
  "起草每周 1:1 议程，突出阻塞项和成长目标。",
  "比较三种定价模式，并为按量计费 SaaS 推荐一种。",
] as const;
...
export const CHAT_THREADS: readonly ChatThread[] = [
  ...
  },
  {
    ...
    modelId: "gpt-5.4",
    preview: "包含发布时间线和 KPI 的 Q3 数据看板上线计划。",
    searchModeId: "deep-search",
    title: "Q3 上线计划",
    updatedAt: "18 分钟前",
    user: {
