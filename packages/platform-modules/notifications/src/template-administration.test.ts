...
const definition = {
  allowedVariables: [], definitionVersion: 1, enabled: true, notificationType: "platform.synthetic",
  ownerModule: "platform.synthetic", systemSenderName: "System", templateKey: "platform.synthetic.notice", variableCatalogVersion: 1,
} as const;
