...
export type OrganizationWrite =
  ...
  | { readonly effectiveTo: string; readonly factId: string; readonly kind: "close_assignment" | "close_employment" | "close_organization_unit_placement"; readonly workforcePersonId?: string };
